...
public class AdjacentPalidromeCheck {
	...
	public static void main(String[] args) {
		...
		System.out.println(makePalindrome(varOcg));
...
//	step 1: To check if a string is a palindrome using reverse() and equals()
	...
	public static String makePalindrome(String inputedStr) {
		...
		if (checkPalindrome(inputedStr)) {
			return "Your inputed string is palidrome: " + inputedStr;
		}
		...
		for (int i = 0; i < chars.length - 1; i++) {
			...
			if (checkPalindrome(newString)) {
				...
				return "After swapping your string becomes palindome: " + newString;
			}
		...
		return "Your inputed string is not palindrome"; // No palindrome possible
	}

//	swap the character and return t.
